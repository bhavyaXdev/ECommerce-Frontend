...
const Header = () => {
  ...
  return (
    <header className="md:sticky md:top-0 z-50 w-full shadow-sm border-b border-gray-100 ">
      ...
      <div className={`hidden md:block w-full bg-white/90 border-t py-1 border-gray-100`}>
      ...
      <div
        className={`md:hidden flex flex-col w-full  ${isScrolled
            ? "fixed top-0 left-0 z-[60] shadow-md bg-white/80  transition-all  duration-300"
            : "bg-linear-to-b from-[#ff4d6d]  from-1%  to-[#fff] to-70%"
          }`}
      >
        {/* Mobile Search & Action Bar */}
        <div
          className={`flex items-center space-x-3 px-4  ${isScrolled ? "pt-4 " : "pb-3 py-4"}`}
        >
        ...
        <div
          className={`w-full  border-b border-gray-100  ${isScrolled ? "" : "pt-0"}`}
        >
          <div className="flex overflow-x-auto no-scrollbar px-3 space-x-4 pt-3 pb-1">
            {[
              ...
              >
                ...
                <div
                  className={`flex items-center justify-center ${isScrolled ? "hidden" : ""} w-[46px] h-[46px] rounded-[14px] ${tab.active ? "bg-linear-to-b from-[#a2d2ff]" : "bg-transparent"}`}
                >
                ...
                <span className="text-[12px] whitespace-nowrap mt-0.5">
                  {tab.name}
                </span>
              </Link>
            ))}
