  ...
  return (
    <section className="py-12 bg-white overflow-hidden">
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        ...
        <button className="w-full mt-8 py-2 border border-gray-200 rounded-xl flex items-center justify-center gap-2 text-gray-800 font-bold text-sm md:hidden hover:bg-gray-50 transition-colors">
